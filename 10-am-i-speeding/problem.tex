...
\begin{document}
	...
	I cross 4 unit distances at 3u/s, 10 unit distances at 7u/s and 2 unit distances at 4u/s. So the time I take to cross the road is $\frac{4}{3}+\frac{10}{7}+\frac{2}{4} = 1.33+0.7+0.5 = 3.26s$. If the numbers represented the speed limits, the minimum time required to cross the road is 3.26s. 
