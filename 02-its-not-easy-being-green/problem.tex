...
\begin{document}
	...
	\begin{itemize}
		\item The first line of the input contains the integer $n$.
		\item The second line of the input contains a string of length $n$ containing numbers and uppercase letters.
	\end{itemize}
